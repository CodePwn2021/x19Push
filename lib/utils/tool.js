...
function sendMsgToGuild(guild,channel,content) {
  BotGuild.guilds.get(guild).channels.get(channel).sendMessage(content);
  return;
}

function formatTime(dateTime, flag) {
    //格式化时间
...
export { arrayRemove,sendMsgToGuild,formatTime }